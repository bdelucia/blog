    ...
    return (
        <>
            ...
            {isLargeScreen && (
                <div
                    className={cn(
                        "w-80 bg-card border rounded-lg p-6 sticky top-24 shadow-sm max-h-[calc(100vh-6rem)] overflow-y-auto",
                        className
                    )}
                >
                    <TOCContent />
            ...
            {/* Mobile TOC - floating button + sheet for screens <= 1768px */}
            {!isLargeScreen && (
                <Sheet>
                    <SheetTrigger asChild>
                        <Button
                            className="fixed bottom-6 right-6 z-40 h-12 w-12 rounded-full shadow-lg bg-primary hover:bg-primary/90 cursor-pointer"
                            size="icon"
                        >
